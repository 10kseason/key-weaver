...
struct ConversionReport {
    ...
    struct QualityMetrics {
        ...
        bool onnxPolicyRequested = false;
        bool onnxPolicyLoaded = false;
        std::string onnxPolicyProviderRequested = "auto";
        std::string onnxPolicyProviderActive = "off";
        std::vector<std::string> onnxPolicyAvailableProviders;
        int onnxPolicyAttemptedNotes = 0;
        int onnxPolicyEvaluatedCandidates = 0;
        int onnxPolicyAcceptedRelanes = 0;
        int onnxPolicyFallbackRelanes = 0;
        int onnxPolicyRejectedRelanes = 0;
        int onnxPolicySameLaneNoops = 0;
        int onnxPolicyRejectedByOutOfRange = 0;
        int onnxPolicyRejectedByCollision = 0;
        int onnxPolicyRejectedByLnConflict = 0;
        int onnxPolicyRejectedByCreatedJack = 0;
