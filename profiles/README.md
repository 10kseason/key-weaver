...
```bash
python scripts/build_target_k_profile.py --songs-root "D:\osu!\Songs" --target-keys 10 --profile-name keyweaver_10k_style_v1 --profile-kind style --window-ms 1000 --curated-list scripts/u_e_10k_curated_patterns.txt --out profiles/keyweaver_10k_style_v1.json
```
...
```bash
python scripts/build_target_k_profile.py --songs-root "D:\osu!\Songs" --author u_e --author CircusGalop --author-path-prefilter --target-key-path-prefilter --target-keys 10 --profile-name keyweaver_10k_broad_style_v1 --profile-kind style --window-ms 1000 --out profiles/keyweaver_10k_broad_style_v1.json
```
