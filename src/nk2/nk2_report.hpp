...
struct NK2Report {
    ...
    int candidateScoredNotes = 0;
    int candidateScoredLanes = 0;
    int candidateScoreSamples = 0;
    int candidateAcceptedFirstChoice = 0;
    int candidateAcceptedAfterHardGate = 0;
    int candidateDirectFallbacks = 0;
    int candidateRejectedBySameTime = 0;
    int candidateRejectedByLn = 0;
    int candidateRejectedByCreatedJack = 0;
    ...
    double candidateNativeScoreSum = 0.0;
    double candidateRemixScoreSum = 0.0;
    double candidateCoverageScoreSum = 0.0;
    double candidateAnchorScoreSum = 0.0;
    double candidateContinuityScoreSum = 0.0;
    double candidateSourceJackScoreSum = 0.0;
    double candidateJackSafetyScoreSum = 0.0;
    double candidateMotifScoreSum = 0.0;
    double candidateSymmetryScoreSum = 0.0;
    double candidateAdjacentCopyScoreSum = 0.0;
    double candidateTotalScoreSum = 0.0;
